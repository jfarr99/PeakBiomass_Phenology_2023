...
ggplot(subset(ndvi_list_output_df, Growing_Season == "Y"), aes(x = DayOfYear, y = filtered_NDVI, color = as.factor(Year))) + geom_point(alpha = 0.05) +  geom_smooth() + facet_wrap(.~Year) + theme_bw()
